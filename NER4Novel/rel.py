...
class hanlp(object):
    def __init__(self, analyzer = "Perceptron", custom_dict = True ):
        ## 数据集目录
        data_path = "/dlabscratch1/tdai/anaconda3/envs/novel/lib/python3.7/site-packages/pyhanlp/static/data/model/perceptron/large/cws.bin"
